...
const ToastIcon = ({ variant, className }) => {
  ...
  switch (variant) {
    case "success":
      return <CheckCircle className={cn(iconClasses, "text-green-600 dark:text-green-400", className)} />;
    case "error":
      return <AlertCircle className={cn(iconClasses, "text-red-600 dark:text-red-400", className)} />;
    default:
      return null;
  }
};
